...
export default function Card(props: CardProps) {
  return (
    <div className="flex h-auto min-h-96 w-auto min-w-80 cursor-default flex-col justify-between rounded-xl border-2 bg-neutral-100 p-6 text-center shadow-md duration-200 md:hover:scale-105 dark:border-0 dark:bg-slate-700">
      ...
      <Link
        className="mx-3.5 mt-2 flex justify-center self-center rounded border border-black px-4 duration-100 hover:bg-neutral-200 active:bg-neutral-200 dark:border-0 dark:bg-gray-800 hover:dark:bg-gray-900 active:dark:bg-gray-900 md:dark:hover:bg-gray-900"
